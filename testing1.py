...
class Record:
    def __init__(self, name, mod1, mod2, mod3, mod4, mod5, probability):
        self.module1 = str(mod1)
        self.module2 = str(mod2)
        self.module3 = str(mod3)
        self.module4 = str(mod4)
        self.module5 = str(mod5)
        self.probability = str(probability)
        self.name = str(name)

    def __str__(self):
        return (self.name+" | "+self.module1+" | "+self.module2+" | "+self.module3+" | "+self.module4+" | " + self.module5 +" | " +self.probability)
...
def generalAnalytics():
    ...
    while (evaluate):
        ...
        recToAdd = Record(fileTouse, mod1, mod2, mod3, mod4, mod5, prob)
